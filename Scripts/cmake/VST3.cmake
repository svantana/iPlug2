...
if (WIN32)
  ...
  elseif ((CMAKE_HOST_SYSTEM_PROCESSOR MATCHES "ARM64") OR (CMAKE_HOST_SYSTEM_PROCESSOR MATCHES "IA64"))
    set(_paths "C:/Program Files/Common Files/${fn}")
    set(vst3_target_arch "arm64")
  endif()
...
function(iplug_configure_vst3 target)
  ...
  elseif (CMAKE_SYSTEM_NAME MATCHES "Darwin")
    ...
    set_target_properties(${target} PROPERTIES 
      BUNDLE TRUE
      MACOSX_BUNDLE TRUE
      MACOSX_BUNDLE_INFO_PLIST ${CMAKE_SOURCE_DIR}/build-mac/${PLUG_NAME}-VST3-Info.plist
